...
从本仓库下载 `submarine-x86_64.zip`（原始构建来自 [FyraLabs/submarine](https://nightly.link/FyraLabs/submarine/workflows/build/main/submarine-x86_64.zip)），解压后把 `submarine.bin` `dd` 到内置盘。
